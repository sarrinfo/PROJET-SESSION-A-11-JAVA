...
<html>
    ...
    <body>
        <c:choose>
            ...
            <c:when test="${ListVisite == null}">
                <img style="width: 450px; height: 300px; text-align: center" src="images/logo.jpg" alt=""/>
                <h1 style="text-align: center">COSEPRIM</h1>
            </c:when>
        </c:choose>
